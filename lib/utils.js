...
// Vagas ociosas de uma linha: usa o valor já calculado quando presente; senão,
// deriva de plano - trabalhadores + afastados. Compartilhado por dashboard e
// remanejamento (mora aqui para evitar dependência circular entre os módulos).
...
module.exports = { limparValorDash, converterNumeroDash, normalizarChaveDash, formatarDataBancoDash, extrairCompetenciaDash, nomeMesDash, obterUltimaAtualizacaoDash, somaServidor, mesesAteFimDoAno, formatDateInTimeZone, aguardar, calcularOciosasServidor };
