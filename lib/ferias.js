...
const RAW_FIELDS = ["matricula", "registro", "nome", "admissao", "periodoIni", "periodoFim", "limiteGozo", "dias"];
...
async function getFeriasData() {
  return obterOuCarregarJsonCache(
    ...
    async () => {
      ...
      try {
        ...
        for (const r of feriasRaw) {
          ...
          feriasPorMat.get(mat).push({ ini, fim });
        }
